package com.nixsolutions.alextuleninov.threadsconcurrency.alextuleninov.thirteen.task1.test.mapping;

import com.nixsolutions.alextuleninov.threadsconcurrency.alextuleninov.thirteen.task1.mapping.CSVMapper;
...
import com.nixsolutions.alextuleninov.threadsconcurrency.alextuleninov.thirteen.task1.test.AppCSVTable;
...
class CSVMapperTest {
    ...
    void map() throws URISyntaxException {
        ...
        Assertions.assertEquals(ExampleForTestCSVTable.getRow1().get(0), appCSVTable.get(0).name);
